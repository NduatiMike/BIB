...
select * from i_control@IA_USER.MTN.CO.ZA;
...
LEFT OUTER JOIN DW_TASKS T 
on t.dw_task_id = b.dw_task_id
WHERE task_business_area <> 'Finance'
and MAX_DATE_IN_TABLE IS NOT NULL
order by 4
;
...
ROUND((FREE_MB/1024)/(TOTAL_MB/1024)*100,0)||'%' PERC_AVAILABLE, NAME 
